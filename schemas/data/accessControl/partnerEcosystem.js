...
const partnerEcosystemEditors = {
  key: 'partnerEcosystem',
  members: ['prfzX5pq4'], // User ids
};
...
function createGroupDoc(group) {
  return {
    ...
    grants: [
      ...
      {
        filter: "_type == 'marketplacePage'",
        permissions: ['read', 'update', 'create'],
      },
      {
        filter: "_type == 'partnerDetailPage'",
        permissions: ['read', 'update', 'create'],
      },
      {
...
// Create editors
createOrReplaceGroup(createGroupDoc(partnerEcosystemEditors));
